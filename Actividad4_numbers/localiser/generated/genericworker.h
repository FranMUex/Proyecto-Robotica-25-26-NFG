...
using TuplePrx = std::tuple<RoboCompCamera360RGB::Camera360RGBPrxPtr,RoboCompLidar3D::Lidar3DPrxPtr,MODMNIST::MNISTPrxPtr,RoboCompOmniRobot::OmniRobotPrxPtr>;
...
public:
	...
	MODMNIST::MNISTPrxPtr mnist_proxy;
